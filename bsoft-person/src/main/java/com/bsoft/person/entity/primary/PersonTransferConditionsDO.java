...
import com.bsoft.common.key.PersonTransferConditionKey;
...
/**
 * @Author: LKH
 * @DateTime: 2021/3/4 10:27
 * @Description: 根据调动时间查人员调动DO
 */
@Entity
//@IdClass(PersonTransferConditionKey.class)
@Table(name = "person_transfer_condition_view")
public class PersonTransferConditionsDO {
