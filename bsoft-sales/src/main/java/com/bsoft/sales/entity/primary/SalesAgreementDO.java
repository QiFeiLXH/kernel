...
public class SalesAgreementDO {
    ...
    /** 合作内容 */
    @Length(max = 800,message = "合作内容长度不超过800")
    private String cooperateContent;
    /** 落地部门 */
    private String landingDep;

    @Id
    @SequenceGenerator(name="SEQ_KER_SALES_AGREEMENT",allocationSize=1,sequenceName="SEQ_KER_SALES_AGREEMENT")
    @GeneratedValue(generator="SEQ_KER_SALES_AGREEMENT",strategy=GenerationType.SEQUENCE)
