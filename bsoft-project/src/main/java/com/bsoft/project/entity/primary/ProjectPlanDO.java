...
public class ProjectPlanDO {
    ...
    @Id
    @SequenceGenerator(name="seq_pro_plan",allocationSize=1,sequenceName="bsoftmis.seq_pro_plan")
    @GeneratedValue(generator="seq_pro_plan",strategy=GenerationType.SEQUENCE)
