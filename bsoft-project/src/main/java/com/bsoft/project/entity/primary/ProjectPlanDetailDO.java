 ...
 */
@Entity
@Table(name = "bsoftmis.pro_plan_detail")
public class ProjectPlanDetailDO {
    ...
    private List<ProjectPlanDetailDO> children; //子节点
    ...
    @Transient
    public List<ProjectPlanDetailDO> getChildren() {
        return children;
    }

    public void setChildren(List<ProjectPlanDetailDO> children) {
