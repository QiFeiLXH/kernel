 ...
 * @Description 项目责任书-计划回款视图
 */
@Entity
@Table(name = "PRO_DUTY_PAYMENT_VIEW")
public class ProjectDutyPaymentViewDO {
    @Id
    private String id;
    /** 合同编号 */
    ...
    @Transient
    private List<ProjectDutyPaymentViewDO> children;
    ...
    public List<ProjectDutyPaymentViewDO> getChildren() {
        return children;
    }

    public void setChildren(List<ProjectDutyPaymentViewDO> children) {
