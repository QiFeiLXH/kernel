...
@Entity
@Table(name = "SALES_PLAN_REPORT")
public class SalesPlanDO {
    ...
    private String trackDeptName;//跟单部门
    ...
    private String latestDevelopment;//最新进展 跟单信息
    ...
    @Id
    @SequenceGenerator(name="SEQ_SALES_PLAN_REPORT",allocationSize=1,sequenceName="SEQ_SALES_PLAN_REPORT")
    @GeneratedValue(generator="SEQ_SALES_PLAN_REPORT",strategy=GenerationType.SEQUENCE)
