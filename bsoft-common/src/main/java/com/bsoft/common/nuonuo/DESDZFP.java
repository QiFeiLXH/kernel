...
/**
 * @Author: xucl
 * @DateTime: 2020/9/23 18:53
 * @Description: 自动开票，解密文件
 */
public class DESDZFP {
    ...
    public static String encrypt(String xmlStr) {
        ...
        // 使用Base64加密后返回
        return  org.apache.commons.codec.binary.Base64.encodeBase64String(temp);
    }
    ...
    public static String decrypt(String xmlStr) throws Exception {
        ...
        encBuf = org.apache.commons.codec.binary.Base64.decodeBase64(xmlStr);
