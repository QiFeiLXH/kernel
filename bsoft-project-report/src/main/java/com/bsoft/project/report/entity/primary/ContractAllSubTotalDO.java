 ...
 * @BelongsPackage: com.bsoft.project.report.entity.primary
 * @Author: Xuhui Lin
 * @CreateTime: 2020-04-01 09:42
 * @Description: 统计报表：合同级-全部-小计 和 年度
 */
@Entity
@Table(name="KER_REPORT_CONTRACT_ALL_Y_VIEW")
public class ContractAllSubTotalDO {
    @Id
    private Integer id;
