 ...
 */
@Entity
@Table(name = "adm_appliance_stock")
public class    ApplianceStockDO {
    /**主键*/
    @Id
    @SequenceGenerator(name="seq_adm_appliance_stock",allocationSize=1,sequenceName="seq_adm_appliance_stock")
    @GeneratedValue(generator="seq_adm_appliance_stock",strategy=GenerationType.SEQUENCE)
    private Integer id;
    /**物品类别*/
